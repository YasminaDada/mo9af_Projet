            ...
            <div class="container">
                ...
                <div id="mainListDiv" class="main_list">
                    <ul class="navlinks">
                        ...
                        <li><a href="{{ route('Job') }}"><button class="button-78">Devenir Jobber</button></a></li>
                        <li><a href="#"><button class="button-73" role="button">Choisir un service</button></a></li>
             ...
             <div class="layout_item w-25">
              <nav class="c-nav-tool">
                ...
                <ul class="c-nav-tool_list">
                  <li>
                    <a href="/collections/all" class="c-link">Devenir Jobber</a>
                  </li>

                  <li>
                    <a href="/pages/about-us" class="c-link">Chosir un service</a>
                  </li>

                  <li>
                    <a href="/blogs/community" class="c-link">Contact</a>
                  </li>
              ...
              <nav class="c-nav-tool">
                ...
                <ul class="c-nav-tool_list">
                  ...
                  <li class="c-nav-tool_item">
                    <a href="/pages/shipping-returns" class="c-link">Devenir Jobber</a>
                  </li>

                  <li class="c-nav-tool_item">
                    <a href="/pages/help" class="c-link">Choisir service</a>
                  </li>

                  <li class="c-nav-tool_item">
                    <a href="/pages/terms-conditions" class="c-link">Contact</a>
                  </li>
